...
class Prescription_model extends CI_Model
{
    ...
    {
        $query  = $this->db->select("opd_details.*,patients.id as patientid ,patients.patient_name,patients.patient_cnic,patients.email,patients.mobileno,patients.patient_unique_id,patients.age,patients.month,patients.gender,patients.address,staff.name,staff.surname,staff.local_address,staff.qualification,staff.specialization")->join("patients", "patients.id = opd_details.patient_id")->join("staff", "staff.id = opd_details.cons_doctor")->where("opd_details.id", $opdid)->get("opd_details");
