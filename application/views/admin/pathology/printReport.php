            ...
            <div class="col-md-12">
                <div class="">
                   ...
                   <table width="100%" class="printablea4" border="0">
                    ...
                    <?php }?> -->
                    <br>  
                    <table class="printablea4" style="border: 2px solid #999;padding: 7px !important;border-collapse: separate; border-spacing: 10px;" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                    ...
                    <hr style="height: 1px; clear: both;margin-bottom: 5px; margin-top: 5px">
                     ...
                     <table class="printablea4" style="border: 1px solid #999;padding: 3px !important;border-collapse: separate; border-spacing: 10px;" id="testreport" width="100%">
                        <thead>
                            <tr>
                        ...
                        foreach ($parameterdetails as $value) {
                            ...
                            ?>
                        <tr>
                            <td style="width:30%"><?php echo strtoupper($value["parameter_name"]); ?> <span class="dotLines" style="padding-right: 20px; float:right;">...........</span></td>
