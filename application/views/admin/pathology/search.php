                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('pathology test', 'can_add')) { ?>   
                                <a data-toggle="modal" onclick="holdModal('addPathologyTestReport')" class="btn btn-primary btn-sm pathology"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('pathology') . " " . $this->lang->line('test').' '.$this->lang->line('patient'); ?></a> 
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('pathology test', 'can_add')) { ?>   
                            ...
                            <?php } ?>
                          <?php if ($this->rbac->hasPrivilege('add_patho_patient_test_report', 'can_view')) { ?>   
                                <a data-toggle="modal" onclick="holdModal('printTestReportModal')"class="btn btn-primary btn-sm"><i class="fa fa-print"></i> <?php echo $this->lang->line('print') . " ". "Receipt"; ?></a> 
...
<div class="modal fade" id="printTestReportModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document" style="width: 25%;">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"><?php echo $this->lang->line('print') . " " . $this->lang->line('test') . " " . $this->lang->line('reports'); ?></h4> 
            </div> 
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="box-footer">
                <div class="text-center">
                    ...
                    <button type="button" onclick="Print_Report();" class="btn btn-info btn-md"><?php echo $this->lang->line('print'); ?> </button>
                </div>
            </div>
        </div>
    </div>    
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-3"> 
                                            <div class="pull-right">  
                                              <!--<b><?php echo $this->lang->line('patient') . " " . $this->lang->line('photo') ?> </b>-->
                                                ...
                                                ?>        
                                                <img class="modal-profile-user-img img-responsive" src="<?php echo base_url() . $file ?>" id="image_bulk" alt="User profile picture">
                                            </div>           
                                        </div><!-- ./col-md-3 --> 
                                    </div>
                                </div><!--./col-md-8--> 
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="exampleInputFile">
                                                    <?php echo 'TPA' ?></label>
                                                <div>
                                                    <select class="form-control select2" style="width:100%" name='organisation' onchange="get_Charges('')" id="organisation">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group15">
                            <div>
                                <select onchange="get_PatientDetails(this.value,'bulk')" style="width:100%" class="form-control select2"  name='patient_id_bulk' id="addpatient_id_bulk" >
                                    <option value=""><?php echo $this->lang->line('select') . " " . $this->lang->line('patient') ?></option>
                                    <?php foreach ($patients as $dkey => $dvalue) {
                                        ?>
                                        <option value="<?php echo $dvalue["id"]; ?>" <?php
                    ...
                    <div class="col-sm-4 col-xs-5">
                        <div class="form-group15">
                            <?php if ($this->rbac->hasPrivilege('pathology test', 'can_add')) { ?>
                                <a data-toggle="modal" id="add" onclick="holdModal('myModalpa','bulk')" class="modalbtnpatient"><i class="fa fa-plus"></i>  <span><?php echo $this->lang->line('new') . " " . $this->lang->line('patient') ?></span></a> 
                            <?php } ?> 
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="formbatchPathology" accept-charset="utf-8" enctype="multipart/form-data" method="post"  action="">
                            <div class="row row-eq">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div id="ajax_load"></div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 ">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-eq ptt10 test_check" id="append_new_row">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('reporting') . " " . $this->lang->line('date'); ?></label><small class="req"> *</small>
                                                    <input type="text" id="report_date" name="reporting_date_bulk[]" class="form-control date">
                                                    <span class="text-danger"><?php echo form_error('reporting_date_bulk'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger"><?php echo form_error('pathology_report_bulk'); ?></span>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control select2" onchange="getOrganization(this.value,0)" style="width:100%" name='pathology_id_bulk[]' id="pathology_id_bulk_0">
                                                            <option value=" "><?php echo $this->lang->line('select') ?></option>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="exampleInputFile">
                                                        <?php echo 'TPA' ?></label>
                                                    <div>
                                                        <select class="form-control select2" style="width:100%" name='organisation_bulk[]' onchange="get_Charges('',0)" id="organisation_bulk_0">
                                                            <option value="<?php echo set_value('tpa_charges'); ?>"><?php echo $this->lang->line('select') ?></option>
                                                        
                                                        </select>
                                                    </div>
                                                    <span class="text-danger"><?php echo form_error('tpa_charges_bulk'); ?></span>
                                                </div>
                                            </div> 
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="total_charges" id="total_charges" class="form-control total_charges" >
                                            </div>
                                        
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                    <button type="button" onclick="appendNewRowTest()" class="btn btn-primary pull-right">+</button> 
                                    </div>   
                                </div><!--./col-md-4-->
                            </div><!--./row--> 
                            ...
                            <div class="row">            
                                <div class="box-footer">
                                    <div class="pull-right mrminus8">
                                        <button type="submit" id="formbatchPathologybtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                                    </div>
                                    <div class="pull-right" style="margin-right:10px;">
                                        <button type="button"  data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right printsavebtntest"><?php echo $this->lang->line('save') . " & " . $this->lang->line('print'); ?></button>
                                    </div>
                                    <div class="pull-right cancel-btn-test" style="margin-right:10px;display:none;">
                                        <button type="button" onClick="window.location.reload();"   data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right "><?php echo $this->lang->line('cancel'); ?></button>
                                    </div>
                                </div>
                            </div><!--./row-->  
                        </form>                       
...
<script>
    function Print_Report() {
        var p_name = $("#p_name").val(); var t_date = $("#t_date").val(); var r_date = $("#r_date").val();
        var t_name=$('#t_name').val();
        //alert(r_date);
        if(p_name === "" ) {
            if(p_name === "") { $("#p_name").css("border-color", "#EF5350"); }
        } else {
            if(t_date === "") { t_date = "no_tdate"; }
            if(r_date === "") { r_date = "no_rdate"; }
            window.open("printTestReports/R1/"+p_name+"/"+t_date+"/"+r_date+"/"+t_name,"myNewWinsr","width=1000,height=665,toolbar=0, menubar=no,status=no,resizable=no,location=no,directories=no,scrollbars=yes");
        }
    }
    ...
    function Print_Receipt() {
        ...
        if(p_name === "" ) {
            ...
            if(t_date === "") { t_date = "no_tdate"; }
            if(r_date === "") { r_date = "no_rdate"; }
            window.open("printTestReceipts/R2/"+p_name+"/"+t_date+"/"+r_date,"myNewWinsr","width=1000,height=665,toolbar=0, menubar=no,status=no,resizable=no,location=no,directories=no,scrollbars=yes");
        }
    }
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        if(print_option == 'A4'){
                            ...
                            var url = base_url + 'admin/pathology/printTestReports/R1/'+patientid +'/no_tdate/no_rdate/'+test_ids;
                            setTimeout(() => {
