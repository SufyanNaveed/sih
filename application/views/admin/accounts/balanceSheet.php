            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"> <?php echo 'Balance Sheet'; ?></h3>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="level_id" id="level_id" class="form-control" >
                                            ...
                                            <?php if($levelslist) { foreach($levelslist as $level){ ?>
                                                <option value="<?php echo $level['id']; ?>" data-level-no = "<?php echo $level['level_no']; ?>"><?php echo $level['level_no'].'&nbsp;&nbsp;&nbsp;' .$level['level_name']; ?></option>
                                            <?php } } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="level_no" name="level_no" type="hidden" value="" >
