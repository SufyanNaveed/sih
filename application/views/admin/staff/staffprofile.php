...
<div class="content-wrapper">
 ...
 <?php } ?>
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo 'Commission'; ?></b> <a class="pull-right text-aqua"><?php echo $staff['commission']; ?>%</a>
                            </li>
                            <li class="list-group-item listnoback">
            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <button type="button" class="btn btn-success pull-right bulk_paid" style="display:none;">Bulk Paid</button>
                            <div class="row">
                                                    ...
                                                    foreach ($staff_comission as $key1 => $staff_result){
                                                        ?>
                                                         <tr>
                                                            ...
                                                            <?php if($staff_result->comission_status != 'paid'){?>        
                                                            <div class="form-check">
                                                                <input type="checkbox" class="form-check-input paid_all" name="paid_id" value="<?php echo $staff_result->id ?>" id="piad_id">
                                                            ...
                                                            <td><?php 
                                                                    if ($staff_result->comission_status == 'paid') {
                                                                        echo 'Paid';
                                                                        echo '<a class="btn btn-default dt-button printsavebtn" data-id='.$staff_result->id.' data-print-option="A4" autocomplete="off" title="Print"><span><i class="fa fa-print"></i></span></a>';
                                                                    }else{
                                                                        ?>
...
<script>
    ...
    $(".paid_all").click(function () {
        if($('input.paid_all:checked').length > 0){
            $('.bulk_paid').show(); 
        }else{
            $('.bulk_paid').hide();
        }
 ...
 $(".bulk_paid").click(function(){
    
    var base_url = '<?php echo base_url() ?>';
    var checkValues = $('input[name=paid_id]:checked').map(function()
            {
                return $(this).val();
            }).get();        
    $.ajax({
        type:'POST',
        url: base_url + 'admin/staff/bulkPaid',
...
$(document).ready(function (e) {
    ...
    var comission_id = $(this).attr('data-id');
    if(print_option == 'A4'){
        var base_url = '<?php echo base_url() ?>';
        var url = base_url + 'admin/staff/printPaidInvoice/'+comission_id;
        setTimeout(() => {
