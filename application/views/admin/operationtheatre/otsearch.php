            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-striped table-bordered table-hover test_ajax" cellspacing="0"
                            width="100%">
                            <thead>
                                <tr>
                ...
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table tableover table-striped table-bordered table-hover"
                                        id="tableID">
                                        <tr>
