        ...
        ?>
                    <li class="treeview <?php if($method_name=='emgpatients'){ echo 'active';}?>">
                        <a href="<?php echo base_url(); ?>admin/patient/queeList">
                            <i class="fas fa-stethoscope"></i> <span> <?php echo $this->lang->line('quee'); ?></span>
                        </a>
                    </li>
                <?php }
    ...
    if ($this->module_lib->hasActive('birth_death_report')) {
        ...
        if ($this->rbac->hasPrivilege('staff_attendance_report', 'can_view')) {
            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffattendance/bioreport'); ?>"><a href="<?php echo base_url(); ?>admin/staffattendance/bioreport"><i class="fas fa-angle-right"></i> <?php echo 'BIO Attendance Report'; ?></a></li>
                                <?php
                }
