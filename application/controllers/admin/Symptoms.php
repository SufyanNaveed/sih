...
class Symptoms extends Admin_Controller
{
    ...
    public function addsymadd()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $symtomID=$this->symptoms_model->addsymtype($data);
            $append_prescription_symtom=array(
                'id'=> $symtomID,
                'problem_name'=>$this->input->post('symptoms_type'),
            );
            $array = array('status' => 'success', 'error' => '', 'message' => $this->lang->line('new_symptoms_type_successfully_inserted'),'append_prescription_symtom'=>$append_prescription_symtom);
        }
